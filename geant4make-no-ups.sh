...
#
node_name=`uname -n`
# --> tev.fnal.gov env_setup=/g4/g4p/pbs/g4-had-validation/env-setup/g4-datasets-setup-${G4RELEASE}.sh
env_setup=/wclustre/g4p/g4p/download/g4data/g4-datasets-setup-${G4RELEASE}.sh
