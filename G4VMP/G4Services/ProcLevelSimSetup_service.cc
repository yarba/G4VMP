...
G4VMP::ProcLevelSimSetupService::ProcLevelSimSetupService( const fhicl::ParameterSet& pset, 
...
G4VMP::ProcLevelSimSetupService::~ProcLevelSimSetupService()
{ 
...
void G4VMP::ProcLevelSimSetupService::Init()
{
...
using G4VMP::ProcLevelSimSetupService;
