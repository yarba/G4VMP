...
#include "G4VMP/G4WrapperComponents/ModelConfigMapper.hh"


G4VMP::PhysModelConfigService::PhysModelConfigService( const fhicl::ParameterSet& pset, 
...
G4VMP::PhysModelConfigService::~PhysModelConfigService()
{
...
void G4VMP::PhysModelConfigService::PrintDefaultSettings()
{
...
void G4VMP::PhysModelConfigService::ConfigureModel( const std::string& mname, 
...
void G4VMP::PhysModelConfigService::Reset()
{
...
void G4VMP::PhysModelConfigService::PrintCurrentSettings()
{
...
void G4VMP::PhysModelConfigService::DoConfigure( const std::string& mod, 
