...
G4VmpRecordChi2::G4VmpRecordChi2( const G4VmpRecordChi2& rhs )
   : TNamed(rhs)
{
...
G4VmpRecordChi2::G4VmpRecordChi2( TRootIOCtor* )
   : TNamed()
{
}

bool G4VmpRecordChi2::InsertRecord( const int rid, 
                                    const double chi2, 
				    const double ndf, 
				    const double wt )
{
...
bool G4VmpRecordChi2::AddMCBin2Record( const int ir, 
                                       const int ib, 
				       const double dchi2 )
{
...
double G4VmpRecordChi2::GetSumChi2() const
{
...
double G4VmpRecordChi2::GetSumNDF() const
{
...
void G4VmpRecordChi2::Print( Option_t* ) const
{
...
bool G4VmpRecordChi2::operator==( const G4VmpRecordChi2& rhs ) const
{
