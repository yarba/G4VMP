...
G4VMP::G4VmpParticle::G4VmpParticle()
{
...
G4VMP::G4VmpParticle::G4VmpParticle( const int pdg, const CLHEP::HepLorentzVector& mom )
{
...
G4VMP::G4VmpParticle::G4VmpParticle( const int pdg, const CLHEP::Hep3Vector& mom )
{
...
G4VMP::G4VmpParticle::G4VmpParticle( const G4VMP::G4VmpParticle& other )
   : fPDG(other.fPDG), fMomentum(other.fMomentum)
{
}

void G4VMP::G4VmpParticle::SetPDG( const int pdg )
{
...
void G4VMP::G4VmpParticle::SetMomentum( const CLHEP::HepLorentzVector& mom )
{
...
void G4VMP::G4VmpParticle::SetMomentum( const CLHEP::Hep3Vector& mom )
{
...
std::string G4VMP::G4VmpParticle::GetName() const 
{
