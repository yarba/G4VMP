#include "G4VMP/DataProducts/ModelConfig/G4VmpModelConfig.hh"

#include "fhiclcpp/ParameterSet.h"

void G4VMP::G4VmpModelConfig::Fill( const fhicl::ParameterSet& pset )
{
...
void G4VMP::G4VmpModelConfig::DoFill( std::string& key, std::string& modkey, fhicl::ParameterSet& mpset )
{
...
void G4VMP::G4VmpModelConfig::Insert( const std::string& model, const std::string& param, const double& value )
{
...
std::vector<std::string> G4VMP::G4VmpModelConfig::GetConfiguredModels() const
{
...
const std::vector< std::pair<std::string,double> >* G4VMP::G4VmpModelConfig::GetConfig( const std::string& model ) const
{
