...
#include "G4VMP/ExpDataAccess/DoSSiERConnect.hh"
#include "G4VMP/ExpDataAccess/ASCIIRecord.hh"
...
G4VMP::AnalyzerWithExpDataBase::AnalyzerWithExpDataBase( const fhicl::ParameterSet& p )
  : art::EDAnalyzer(p),
...
G4VMP::AnalyzerWithExpDataBase::~AnalyzerWithExpDataBase()
{
...
void G4VMP::AnalyzerWithExpDataBase::endJob()
{
...
bool G4VMP::AnalyzerWithExpDataBase::matchVDBRec2MC( const int& bid,
                                                     const double& bmom,
						     const int& tgt )
{
...
bool G4VMP::AnalyzerWithExpDataBase::findExpDataByBeamTarget( const int& bid, 
                                                              const double& bmom, 
                                                              const int& tgt )
{
...
void G4VMP::AnalyzerWithExpDataBase::rebinMC2Data( const std::string& tag2rm )
{
...
TH1D* G4VMP::AnalyzerWithExpDataBase::copyHisto2TFS( TH1D* htmp, const std::string& tag2rm )
{
...
void G4VMP::AnalyzerWithExpDataBase::overlayDataMC()
{
