...
namespace G4VMP {
   ...
   class AnalyzerHARP : public G4VmpAnalyzerBase {
...
G4VMP::AnalyzerHARP::~AnalyzerHARP()
{
...
void G4VMP::AnalyzerHARP::beginJob()
{
...
void G4VMP::AnalyzerHARP::analyze( const art::Event& e )
{
...
void G4VMP::AnalyzerHARP::calculateChi2()
{
