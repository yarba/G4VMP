...
namespace G4VMP {
   ...
   class AnalyzerITEP : public G4VmpAnalyzerBase {
...
G4VMP::AnalyzerITEP::AnalyzerITEP( const fhicl::ParameterSet& p )
...
G4VMP::AnalyzerITEP::~AnalyzerITEP()
{
...
void G4VMP::AnalyzerITEP::beginJob()
{
...
void G4VMP::AnalyzerITEP::endJob()
{
...
void G4VMP::AnalyzerITEP::analyze( const art::Event& e )
{
...
TH1* G4VMP::AnalyzerITEP::matchExpSpectrum2MC( const int& secid, 
...
std::string G4VMP::AnalyzerITEP::extractThetaFromTitle( const std::string& title )
{
...
void G4VMP::AnalyzerITEP::calculateChi2()
{
