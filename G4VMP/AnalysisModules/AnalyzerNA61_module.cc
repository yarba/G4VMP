...
namespace G4VMP {
   ...
   class AnalyzerNA61 : public G4VmpAnalyzerBase {
...
G4VMP::AnalyzerNA61::AnalyzerNA61( const fhicl::ParameterSet& p )
...
G4VMP::AnalyzerNA61::~AnalyzerNA61()
{
...
void G4VMP::AnalyzerNA61::beginJob()
{
...
void G4VMP::AnalyzerNA61::endJob()
{
...
void G4VMP::AnalyzerNA61::analyze( const art::Event& e )
{
...
TH1* G4VMP::AnalyzerNA61::matchExpSpectrum2MC( const int& secid, 
...
std::vector<std::string> G4VMP::AnalyzerNA61::extractThetaBinFromTitle( const std::string& title )
{
...
void G4VMP::AnalyzerNA61::calculateChi2()
{
