...
namespace G4VMP {
   ...
   class AnalyzerIAEA : public G4VmpAnalyzerBase {
...
G4VMP::AnalyzerIAEA::AnalyzerIAEA( const fhicl::ParameterSet& p )
...
G4VMP::AnalyzerIAEA::~AnalyzerIAEA()
{
...
void G4VMP::AnalyzerIAEA::beginJob()
{
...
void G4VMP::AnalyzerIAEA::endJob()
{
...
void G4VMP::AnalyzerIAEA::analyze( const art::Event& e )
{
...
TH1* G4VMP::AnalyzerIAEA::matchExpSpectrum2MC( const int& secid, 
...
std::string G4VMP::AnalyzerIAEA::extractThetaFromTitle( const std::string& title )
{
...
void G4VMP::AnalyzerIAEA::calculateChi2()
{
