...
#include "G4VMP/StatAnalysisTools/Chi2Calc.hh"
#include "G4VMP/DataProducts/Analysis/G4VmpRecordChi2.hh"
...
namespace G4VMP {
   ...
   class AnalyzerNA49 : public G4VmpAnalyzerBase {
...
G4VMP::AnalyzerNA49::AnalyzerNA49( const fhicl::ParameterSet& p )
...
G4VMP::AnalyzerNA49::~AnalyzerNA49()
{
...
void G4VMP::AnalyzerNA49::beginJob()
{
...
void G4VMP::AnalyzerNA49::endJob()
{
...
void G4VMP::AnalyzerNA49::analyze( const art::Event& e )
{
...
*/
   const G4VmpParticle& primary = firstint->GetIncoming();
   ...
   for ( int ip=0; ip<nsec; ++ip )
   {
      ...
      const G4VmpParticle& sec = firstint->GetOutcoming( ip );
...
TH1* G4VMP::AnalyzerNA49::matchExpSpectrum2MC( const int& secid, 
...
double G4VMP::AnalyzerNA49::calculateBinWeight( const CLHEP::HepLorentzVector& labp, 
...
void G4VMP::AnalyzerNA49::calculateChi2()
{
...
std::string G4VMP::AnalyzerNA49::extractXFBinFromTitle( const std::string& title )
{
