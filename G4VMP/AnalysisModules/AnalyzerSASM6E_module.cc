...
namespace G4VMP {
   ...
   class AnalyzerSASM6E : public G4VmpAnalyzerBase {
...
G4VMP::AnalyzerSASM6E::AnalyzerSASM6E( const fhicl::ParameterSet& p )
...
G4VMP::AnalyzerSASM6E::~AnalyzerSASM6E()
{
...
void G4VMP::AnalyzerSASM6E::beginJob()
{
...
void G4VMP::AnalyzerSASM6E::endJob()
{
...
void G4VMP::AnalyzerSASM6E::analyze( const art::Event& e )
{
...
TH1* G4VMP::AnalyzerSASM6E::matchExpSpectrum2MC( const int& secid, 
...
void G4VMP::AnalyzerSASM6E::calculateChi2()
{
...
std::string G4VMP::AnalyzerSASM6E::extractPTBinFromTitle( const std::string& title )
{
...
double G4VMP::AnalyzerSASM6E::computeDPZ( double bc, double bw, int id )
{
